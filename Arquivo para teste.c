//!!!TODAS AS VARIÁVEIS JÁ ESTÃO INICIALIZADAS COM DETERMINADO VALOR AFIM DE POUPAR TEMPO AO EXECUTAR OS TESTES!!!.
...
printf("\n\nComparar atributos das cartas?\n");
    ...
    switch (opção) {
        case 1:
        printf("Voce escolherá dois atributos para comparar\n");
        printf("**Atenção!**\nVocê não pode escolher os mesmos atributos.\n");
